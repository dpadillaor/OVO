...
class OVOSemMap():
    ...
    def save_representation(self) -> None:
        ...
        self.ovo.contest.dump(str(self.output_path / "fusion" / "contest" / "contest.json"))
        self.ovo.contest.dump_verdicts(str(self.output_path / "fusion" / "contest" / "contest_verdicts.csv"))
